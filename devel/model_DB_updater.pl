#!/usr/bin/env perl
#
# File bootstrapped by RapidApp 1.210101
#
...
my $app_class   = 'Rapi::Blog';
my $model_class = 'Rapi::Blog::Model::DB';
...
if($from_ddl) { # from_ddl logic
  ...
  my $ddl = file($approot,'sql/rapi_blog.sql')->resolve;
...
=head1 NAME
model_DB_updater.pl - updater script for RapidDbic model 'Rapi::Blog::Model::DB'
